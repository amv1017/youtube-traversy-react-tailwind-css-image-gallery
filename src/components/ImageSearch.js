    ...
    <div className='max-w-sm rounded overflow-hidden my-10 mx-auto'>
      <form onSubmit={onSubmit} className="w-full max-w-sm">
        <div className="flex items-center border-b border-b-2 border-teal-500 py-2">
          ...
          <button style={{backgroundColor: '#38b2ac'}} className="flex-shrink-0 bg-green-400 hover:bg-teal-700 border-teal-500 hover:border-green-300 text-sm border-4 text-white py-1 px-2 rounded" type="submit">
            Search
          </button>
        </div>
      </form>
